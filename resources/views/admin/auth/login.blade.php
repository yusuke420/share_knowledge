<x-guest-layout>
    ...
    <div class="bg-white py-6 sm:py-8 lg:py-12">
        <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
            <h2 class="mb-4 text-center text-2xl font-bold text-gray-800 md:mb-8 lg:text-3xl">管理者ログイン</h2>
            <form method="POST" action="{{ route('admin.login') }}" class="mx-auto max-w-lg rounded-lg border">
                @csrf
                ...
                <div class="flex items-center justify-center bg-gray-100 p-4">
                    ...
                    <p class="text-center text-sm text-gray-500">パスワードをお忘れの方は<a class="text-indigo-500 transition duration-100 hover:text-indigo-600 active:text-indigo-700" href="{{ route('admin.password.request') }}">
                            {{ __('こちら') }}
                        </a></p>
                    @endif
                </div>
