                            ...
                            <ul class="items-center w-full text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-lg sm:flex dark:bg-gray-700 dark:border-gray-600 dark:text-white" id="importance" type="importance" name="importance" required autocomplete="importance">
                                <li class="w-full border-b border-gray-200 sm:border-b-0 sm:border-r dark:border-gray-600">
                                    <div class="flex items-center pl-3">
                                        <input id="importance-high" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500" type="radio" name="importance" value="high" checked="{{ $post['importance'] == '1' ? 'checked' : '' }}" required autocomplete="importance" />
                                        <label for="importance-high" class="w-full py-3 ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">高</label>
                                    </div>
                                </li>
                                <li class="w-full border-b border-gray-200 sm:border-b-0 sm:border-r dark:border-gray-600">
                                    <div class="flex items-center pl-3">
                                        <input id="importance-mid" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500" type="radio" name="importance" value="medium" checked="{{ $post['importance'] == '2' ? 'checked' : '' }}" required autocomplete="importance" />
                                        <label for="importance-mid" class="w-full py-3 ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">中</label>
                                    </div>
                                </li>
                                <li class="w-full dark:border-gray-600">
                                    <div class="flex items-center pl-3">
                                        <input id="importance-low" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500" type="radio" name="importance" value="low" checked="{{ $post['importance'] == '3' ? 'checked' : '' }}" required autocomplete="importance" />
