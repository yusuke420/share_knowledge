...
export default function () {
    store.registerHook(
        ...
        (directive, el, component) => {
            ...
            let start = () =>
                el.dispatchEvent(
                    new CustomEvent("livewire-upload-start", { bubbles: true })
                );
            let finish = () =>
                el.dispatchEvent(
                    new CustomEvent("livewire-upload-finish", { bubbles: true })
                );
            let error = () =>
                el.dispatchEvent(
                    new CustomEvent("livewire-upload-error", { bubbles: true })
                );
