            ...
            createTabs: function () {
                ...
                for (var i = 0; i < tabGroups.length; i++) {
                    ...
                    for (var j = 0; j < tabs.length; j++) {
                        var tabId = "tab-" + i + "-" + j;
                        var tabTitle =
                            tabs[j].querySelector(".tab-title").innerHTML;
                    ...
                    tabGroups[i].insertBefore(
                        tabNavigation,
                        tabGroups[i].firstChild
                    );
                    addClass(
            ...
            createToggles: function () {
                ...
                for (var i = 0; i < toggles.length; i++) {
                    ...
                    if (
                        ...
                        toggles[i].getAttribute("data-toggle-initial") ==
                            "display"
                    ) {
                    ...
                    addEventListener(toggles[i], "click", function (e) {
                        ...
                        if (
                            !toggle.hasAttribute("data-toggle-original-content")
                        ) {
                            toggle.setAttribute(
                        ...
                        var altContent = toggle.getAttribute(
                            "data-toggle-alt-content"
                        );
                        toggle.innerHTML =
